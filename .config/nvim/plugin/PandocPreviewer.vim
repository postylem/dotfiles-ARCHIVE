...
function! s:RenderHTML()
  let s:md=shellescape(expand('%:p'))
  let s:mdhtml=shellescape(expand('%:p') . '.html')
  execute "silent ! /Users/j/Documents/GitLab/logs/use-pandoc-local.sh "
        \ . s:md . " " . s:mdhtml
endfunction
...
function! s:ViewHTML()
  call s:RenderHTML()
  let s:mdhtml=shellescape(expand('%:p') . '.html')
  execute "silent !" . s:browser . " " . s:mdhtml . " &"
  echo "HTML preview generated. "
        \ . "Type any character to return, and remove preview."
  call getchar()
  call s:RemoveHTML()
endfunction
